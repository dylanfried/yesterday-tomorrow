...
p_melody = Population(500,yesterday,tomorrow,(0,88),10)
p_time = Population(500,yesterday_time,tomorrow_time,(-64,64),4)
...
while True:
    ...
    if last_melody_fitness - p_melody.most_fit() > 1000:
        ...
        last_melody_fitness = p_melody.most_fit()
    if p_melody.most_fit() <= 250 and p_time.most_fit() <= 100:
        break
